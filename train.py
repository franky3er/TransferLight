...
if __name__ == "__main__":
    ...
    scenarios_dir = os.path.join(SCENARIOS_ROOT, "train", "random-network")
    ...
    generalight_environment = MultiprocessingMarlEnvironment(scenarios_dir=scenarios_dir, max_patience=max_waiting_time,
                                                             problem_formulation="GeneraLightProblemFormulation",
                                                             n_workers=workers)
    ...
    A2C(actor_critic_network, entropy_loss_weight=0.0).fit(generalight_environment, steps=steps, checkpoint_path="agents/A2C/actor-critic-checkpoint.pt")
