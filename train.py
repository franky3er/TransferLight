...
if __name__ == "__main__":
    ...
    agents = IA2CAgents(actor_heterogeneous, critit_heterogeneous, 0.001, 0.001, 0.9, 0.01, checkpoint_dir=os.path.join("agents", "IA2C"), save_checkpoint=True)
